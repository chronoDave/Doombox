...
export { default as AppearanceView } from './settings/Appearance.view';
export { default as LanguageView } from './settings/Language.view';
export { default as ConnectionsView } from './settings/Connections.view';
